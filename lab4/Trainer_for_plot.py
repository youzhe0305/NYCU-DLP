...
from utils import training_loss_plot, training_loss_log, validation_psnr_plot
...
class VAE_Model(nn.Module):
    ...
    def training_stage(self):
        ...
        for i in range(self.args.num_epoch):
            ...
            avg_loss = total_loss.item() / batch_num
        ...
        training_loss_plot((epoch_record,loss_record),  self.args.plot_kind +'.jpg', self.args.plot_kind)
        training_loss_log(loss_record, self.args.plot_kind + '.txt')
    @torch.no_grad()
    def eval(self):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--plot_kind', type=str, default='plot',       help="")
