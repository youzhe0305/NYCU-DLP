...
class OxfordPetDataset(torch.utils.data.Dataset):
    ...
    def _read_split(self): # get filename for index
...
# resize picture to 256*256 and change dim from (height, width, channel) to (channel, height, width) which pytorch use
